                                        ...
                                        <div class="twt-feed teal-bg">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="text-light inline-block"><?php echo $player['playing_role']; ?></p>
                                                    <p class="text-light inline-block"><b><?php echo $player['batting_style']; ?></b></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="weather-category twt-category">
                                            <ul>
                                                <li class="active">
                                                    <h4 class="text-dark"><?php echo $player['matches']; ?></h4>
                                                    Total Matches
                                                </li>
                                                <li>
                                                    <h4 class="text-dark"><?php echo $player['runs']; ?></h4>
                                                    Total Runs
                                                </li>
                                                <li>
                                                    <h4 class="text-dark"><?php echo $player['wickets']; ?></h4>
                                                    Total Wickets
                                                </li>
                                            </ul>
                                        </div>
