                    ...
                    <div class="col-md-12">
                        <section class="card">
                            <div class="twt-feed blue-bg">
                                ...
                                <div class="media">
                                    <a href="#">
                                        <img class="align-self-center mr-3 bg-dark rounded-circle p-1" alt="profile pic" src="<?php if ($player_info[0]->image_address == '') {
                                                                                                                                    echo base_url() . "images/profile_pic/default.png";
                                                                                                                                } else {
                                                                                                                                    echo base_url() . $player_info[0]->image_address;
                                                                                                                                } ?>" style="width:110px; height:110px;">
                                    </a>
                                    <div class="media-body">
                                        <h3 class="text-white display-6"><?php echo $player_info[0]->full_name; ?></h3>
                                        <p class="text-light inline-block"><?php echo $player_info[0]->playing_role; ?></p>
                                        <p class="text-light inline-block"><b><?php echo $player_info[0]->batting_style; ?></b></p>
                                    </div>
                                </div>
                            </div>
                            <div class="weather-category twt-category">
                                <ul>
                                    <li class="active">
                                        <h4 class="text-dark"><?php echo $player_stats[0]->matches; ?></h4>
                                        Total Matches
                                    </li>
                                    <li>
                                        <h4 class="text-dark"><?php echo $player_stats[0]->runs; ?></h4>
                                        Total Runs
                                    </li>
                                    <li>
                                        <h4 class="text-dark"><?php echo $player_stats[0]->wickets; ?></h4>
                                        Total Wickets
                                    </li>
                                </ul>
                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->matches; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->batting_innings; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->not_out; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->runs; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->highest_runs; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->batting_avg; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->batting_sr; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->fifties; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->hundreds; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->ducks; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->won; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->loss; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    <div class="stat-text">Innings</div>
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->balling_innings; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->overs; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->maidens; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->wickets; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    <div class="stat-text">Avg</div>
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->balling_avg; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    <div class="stat-text">Runs</div>
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->give_runs; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->best_balling; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->five_wickets; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->dot_balls; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->give_fours; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="stat-widget-one">
                                                                <div class="stat-content dib">
                                                                    ...
                                                                    <div class="stat-digit"><?php echo $player_stats[0]->give_sixes; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
