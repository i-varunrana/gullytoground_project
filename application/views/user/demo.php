...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url('tournaments'); ?>"> <i class="menu-icon fa fa-soccer-ball-o"></i>My Tournaments</a>
                    </li>
                    <li>
                        <a id="add-tournament" data-name="<?php echo $user_info[0]->full_name; ?>"> <i class="menu-icon fa fa-plus-square"></i>Add A Tournament</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header bg-white br-0 d-flex justify-content-between">
                                <strong class="card-title inline-block">Add Players</strong>
                                <div class="search-player-wrapper">
                                <input class="search-player" type="text" placeholder="Search player..." aria-label="Search">
                                <button class="search-player-btn" type="submit">Search</button>
                                </div>
                            </div>
                            <div class="card-body card-block">
                                ...
                                <div class="players-card col-md-6">
                                    <div class="head">
                                        <div class="player-dp">
                                            <img src="<?php echo base_url();?>dp/9758585895.jpg" alt="" width="110">
                                            <div class="name">
                                                <p>varun rana</p>
                                            </div>
                                       </div>
                                        ...
                                        <div class="user-info">
                                            <div class="basic-info">
                                                <div class="playing-style">
                                                    <i class="fa fa-info-circle"></i>&nbsp; Batsman RHB
                                                </div>
                                                <div class="city">
                                                    <i class="fa fa-map-marker"></i>&nbsp; Bulandshahr
                                                </div>
                                            </div>
                                            <div class="add-btn">
    ...
    <script src="<?php echo base_url(); ?>js/userscript.js"></script>
                                    ...
                                    ?>
                                            <div class="team-player-card col-md-5">
                                                <div class="head">
